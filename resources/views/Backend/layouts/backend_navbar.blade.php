...
<div class="navbar navbar-inverse" role="navigation">
    ...
    <ul class="nav navbar-nav navbar-right collapse" id="navbar-icons">
        ...
        <li class="user dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown">
                <img src="{{ Auth::user()->image != '' ? asset(Auth::user()->image) : '' }}" style="border-radius: 50%;">
                <span>{{Auth::user()->name}}</span>
                <i class="caret"></i>
            </a>
            <ul class="dropdown-menu dropdown-menu-right icons-right">
                <li class="{{ (request()->is('admin/profile')) ? 'active' : '' }}"><a href="{{url('/admin/profile')}}"><i class="icon-user"></i> Profile</a></li>
                <li class="{{ (request()->is('admin/password')) ? 'active' : '' }}"><a href="{{url('/admin/password')}}"><i class="icon-lock form-control-feedback"></i> Setting</a></li>
